...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 2
    answer = count_cosines_from(4, 7, 0.17)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 2
    answer = count_cosines_from(4, 9, 0.35)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 2
    answer = count_cosines_from(1, 7, 0.6)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 0
    answer = count_cosines_from(8, 10, 0.5)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 6
    answer = count_cosines_from(0, 12, 0.1)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 0.6166666  # This is APPROXIMATELY the correct answer.
