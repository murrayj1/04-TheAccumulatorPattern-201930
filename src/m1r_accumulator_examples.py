...
#
#       The _ means that the user doesn't care about the looping variable; the only thing the
#       user desires is the looping itself.
#
...
#                  circle = rg.Circle(point, radius)        <------------------WRONG
#                  circle.attach_to(window)
#
#              x = starting_point.x
#              for k in range(n):
